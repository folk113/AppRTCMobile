...
public class WebRtcAudioEffects {
  ...
  // Checks if the device implements Acoustic aec Cancellation (AEC).
  ...
  // Returns true if the device supports Acoustic aec Cancellation (AEC).
  ...
  // Acoustic aec Canceler (AEC) or Automatic Gain Control (AGC) or
