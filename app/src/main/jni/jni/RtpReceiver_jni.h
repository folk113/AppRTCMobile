...
static jboolean JNI_RtpReceiver_SetParameters(JNIEnv* env, jlong rtpReceiver,
...
JNI_GENERATOR_EXPORT jboolean Java_org_webrtc_RtpReceiver_nativeSetParameters(
    ...
    jlong rtpReceiver,
    jobject parameters) {
  return JNI_RtpReceiver_SetParameters(env, rtpReceiver, base::android::JavaParamRef<jobject>(env,
      parameters));
}
