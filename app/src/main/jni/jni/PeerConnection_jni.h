...
static jint Java_IntervalRange_getMin(JNIEnv* env, const base::android::JavaRef<jobject>& obj) {
  jclass clazz = org_webrtc_PeerConnection_00024IntervalRange_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
...
static std::atomic<jmethodID>
    g_org_webrtc_PeerConnection_00024RTCConfiguration_getUseMediaTransport(nullptr);
static jboolean Java_RTCConfiguration_getUseMediaTransport(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  jclass clazz = org_webrtc_PeerConnection_00024RTCConfiguration_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_PeerConnection_00024RTCConfiguration_clazz(env), false);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          env,
          clazz,
          "getUseMediaTransport",
          "()Z",
          &g_org_webrtc_PeerConnection_00024RTCConfiguration_getUseMediaTransport);
...
static std::atomic<jmethodID>
    g_org_webrtc_PeerConnection_00024RTCConfiguration_getUseMediaTransportForDataChannels(nullptr);
static jboolean Java_RTCConfiguration_getUseMediaTransportForDataChannels(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  jclass clazz = org_webrtc_PeerConnection_00024RTCConfiguration_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_PeerConnection_00024RTCConfiguration_clazz(env), false);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          env,
          clazz,
          "getUseMediaTransportForDataChannels",
          "()Z",
          &g_org_webrtc_PeerConnection_00024RTCConfiguration_getUseMediaTransportForDataChannels);
