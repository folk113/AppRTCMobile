...
static base::android::ScopedJavaLocalRef<jobject> Java_Encoding_Constructor(JNIEnv* env, const
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          clazz,
          "<init>",
"(Ljava/lang/String;ZLjava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Double;Ljava/lang/Long;)V",
          &g_org_webrtc_RtpParameters_00024Encoding_Constructor);

  jobject ret =
      env->NewObject(clazz,
          call_context.base.method_id, rid.obj(), active, maxBitrateBps.obj(), minBitrateBps.obj(),
              maxFramerate.obj(), numTemporalLayers.obj(), scaleResolutionDownBy.obj(), ssrc.obj());
...
"(Ljava/lang/String;Lorg/webrtc/RtpParameters$Rtcp;Ljava/util/List;Ljava/util/List;Ljava/util/List;)V",
  ...
  jobject ret =
      env->NewObject(clazz,
          call_context.base.method_id, transactionId.obj(), rtcp.obj(), headerExtensions.obj(),
              encodings.obj(), codecs.obj());
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}
